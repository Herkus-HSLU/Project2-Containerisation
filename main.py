...
def main(args, parser):
    ...
    run_name = get_run_name(args, parser)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Hyperparameter Tuning with GLUE Dataset")
    ...
    parser.add_argument("--warmup_steps", type=int, default=0, help="Warmup steps for the learning rate scheduler")
    ...
    parser.add_argument("--run_name", type=str, help="WILL OVERRIDE DEFAULT AUTO NAMING")
